		...
		test.AccountA: {
			...
			ledger.Creatable{Index: 2, Type: basics.AssetCreatable}: {
				...
				AssetParams: &basics.AssetParams{
					Total:         txn1.Txn.AssetParams.Total,
					Decimals:      txn1.Txn.AssetParams.Decimals,
					DefaultFrozen: txn1.Txn.AssetParams.DefaultFrozen,
					UnitName:      txn1.Txn.AssetParams.UnitName,
					AssetName:     txn1.Txn.AssetParams.AssetName,
					URL:           txn1.Txn.AssetParams.URL,
					MetadataHash:  txn1.Txn.AssetParams.MetadataHash,
					Manager:       txn1.Txn.AssetParams.Manager,
					Reserve:       txn1.Txn.AssetParams.Reserve,
					Freeze:        txn1.Txn.AssetParams.Freeze,
					Clawback:      txn1.Txn.AssetParams.Clawback,
				},
			},
			ledger.Creatable{Index: 3, Type: basics.AssetCreatable}: {
				...
				AssetParams: &basics.AssetParams{
					Total:         txn2.Txn.AssetParams.Total,
					Decimals:      txn2.Txn.AssetParams.Decimals,
					DefaultFrozen: txn2.Txn.AssetParams.DefaultFrozen,
					UnitName:      txn2.Txn.AssetParams.UnitName,
					AssetName:     txn2.Txn.AssetParams.AssetName,
					URL:           txn2.Txn.AssetParams.URL,
					MetadataHash:  txn2.Txn.AssetParams.MetadataHash,
					Manager:       txn2.Txn.AssetParams.Manager,
					Reserve:       txn2.Txn.AssetParams.Reserve,
					Freeze:        txn2.Txn.AssetParams.Freeze,
					Clawback:      txn2.Txn.AssetParams.Clawback,
				},
			},
		},
		test.AccountB: {
			ledger.Creatable{Index: 4, Type: basics.AssetCreatable}: {
				...
				AssetParams: &basics.AssetParams{
					Total:         txn3.Txn.AssetParams.Total,
					Decimals:      txn3.Txn.AssetParams.Decimals,
					DefaultFrozen: txn3.Txn.AssetParams.DefaultFrozen,
					UnitName:      txn3.Txn.AssetParams.UnitName,
					AssetName:     txn3.Txn.AssetParams.AssetName,
					URL:           txn3.Txn.AssetParams.URL,
					MetadataHash:  txn3.Txn.AssetParams.MetadataHash,
					Manager:       txn3.Txn.AssetParams.Manager,
					Reserve:       txn3.Txn.AssetParams.Reserve,
					Freeze:        txn3.Txn.AssetParams.Freeze,
					Clawback:      txn3.Txn.AssetParams.Clawback,
				},
			},
		},
	}
