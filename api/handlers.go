	...
	for row := range assetchan {
		...
		asset := generated.Asset{
			...
			Params: generated.AssetParams{
				...
				Name:          strPtr(row.Params.AssetParams.AssetName),
				NameB64:       bytePtr(row.Params.AssetNameBytes),
				UnitName:      strPtr(row.Params.AssetParams.UnitName),
				UnitNameB64:   bytePtr(row.Params.UnitNameBytes),
				Url:           strPtr(row.Params.AssetParams.URL),
				UrlB64:        bytePtr(row.Params.URLBytes),
