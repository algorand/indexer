...
RUN apt-get update && apt-get -y install awscli apt-transport-https ca-certificates software-properties-common build-essential curl git python3 python3-pip && \
