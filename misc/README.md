...
The process for updating the `make e2e`'s input is automatic.  The test will initialize the sub-module within the indexer repository to generate the tests.
