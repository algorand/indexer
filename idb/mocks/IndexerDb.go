...
func (_m *IndexerDb) GetBlock(ctx context.Context, round uint64, options idb.GetBlockOptions) (bookkeeping.BlockHeader, []idb.TxnRow, error) {
	...
	var r1 []idb.TxnRow
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, uint64, idb.GetBlockOptions) (bookkeeping.BlockHeader, []idb.TxnRow, error)); ok {
...
func (_m *IndexerDb) GetSpecialAccounts(ctx context.Context) (transactions.SpecialAddresses, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (transactions.SpecialAddresses, error)); ok {
		return rf(ctx)
	}
