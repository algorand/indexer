...
type ConsensusParams struct {
	...
	// DefaultUpgradeWaitRounds.
	ApprovedUpgrades map[string]uint64
...
type ConsensusProtocols map[string]ConsensusParams
...
func (cp ConsensusProtocols) DeepCopy() ConsensusProtocols {
	...
	for consensusVersion, consensusParams := range cp {
		...
		if consensusParams.ApprovedUpgrades != nil {
			newApprovedUpgrades := make(map[string]uint64)
...
func initConsensusProtocols() {
	...
	v7.ApprovedUpgrades = map[string]uint64{}
	Consensus["v7"] = v7
	...
	v8.ApprovedUpgrades = map[string]uint64{}
	Consensus["v8"] = v8

	// v7 can be upgraded to v8.
	v7.ApprovedUpgrades["v8"] = 0

	// v9 increases the minimum balance to 100,000 microAlgos.
	v9 := v8
	v9.MinBalance = 100000
	v9.ApprovedUpgrades = map[string]uint64{}
	Consensus["v9"] = v9

	// v8 can be upgraded to v9.
	v8.ApprovedUpgrades["v9"] = 0
	...
	v14.ApprovedUpgrades = map[string]uint64{}
	Consensus["v14"] = v14

	// v13 can be upgraded to v14.
	v13.ApprovedUpgrades["v14"] = 0
	...
	v19 := v18
	v19.ApprovedUpgrades = map[string]uint64{}

	Consensus["v19"] = v19

	// v18 can be upgraded to v19.
	v18.ApprovedUpgrades["v19"] = 0
	// v17 can be upgraded to v19.
	v17.ApprovedUpgrades["v19"] = 0

	// v20 points to adding the precision to the assets.
	v20 := v19
	v20.ApprovedUpgrades = map[string]uint64{}
	...
	v23 := v22
	v23.ApprovedUpgrades = map[string]uint64{}
	v23.FixTransactionLeases = true
	Consensus["v23"] = v23
	// v22 can be upgraded to v23.
	v22.ApprovedUpgrades["v23"] = 10000
	// v21 can be upgraded to v23.
	v21.ApprovedUpgrades["v23"] = 0

	// v24 is the stateful teal and rekeying upgrade
	v24 := v23
	v24.ApprovedUpgrades = map[string]uint64{}
	...
	v23.ApprovedUpgrades["v24"] = 140000

	// v25 enables AssetCloseAmount in the ApplyData
	v25 := v24
	v25.ApprovedUpgrades = map[string]uint64{}
	...
	v26 := v25
	v26.ApprovedUpgrades = map[string]uint64{}
	...
	v25.ApprovedUpgrades["v26"] = 140000
	v24.ApprovedUpgrades["v26"] = 140000

	// v27 updates ApplyDelta.EvalDelta.LocalDeltas format
	v27 := v26
	v27.ApprovedUpgrades = map[string]uint64{}
	...
	v28.ApprovedUpgrades["v29"] = 60000
	...
	v30 := v29
	v30.ApprovedUpgrades = map[string]uint64{}
	...
	v29.ApprovedUpgrades["v30"] = 140000

	v31 := v30
	v31.ApprovedUpgrades = map[string]uint64{}
	...
	v30.ApprovedUpgrades["v31"] = 140000

	v32 := v31
	v32.ApprovedUpgrades = map[string]uint64{}
	...
	v31.ApprovedUpgrades["v32"] = 140000

	v33 := v32
	v33.ApprovedUpgrades = map[string]uint64{}
	...
	v32.ApprovedUpgrades["v33"] = 140000

	v34 := v33
	v34.ApprovedUpgrades = map[string]uint64{}
	...
	v35.ApprovedUpgrades = map[string]uint64{}
	...
	v33.ApprovedUpgrades["v35"] = 10000
	v34.ApprovedUpgrades["v35"] = 10000

	v36 := v35
	v36.ApprovedUpgrades = map[string]uint64{}
	...
	v35.ApprovedUpgrades["v36"] = 140000

	// ConsensusFuture is used to test features that are implemented
	// but not yet released in a production protocol version.
	vFuture := v36
	vFuture.ApprovedUpgrades = map[string]uint64{}

	vFuture.LogicSigVersion = 9 // When moving this to a release, put a new higher LogicSigVersion here

	Consensus["future"] = vFuture

	// vAlphaX versions are an separate series of consensus parameters and versions for alphanet
	vAlpha1 := v32
	vAlpha1.ApprovedUpgrades = map[string]uint64{}
	vAlpha1.AgreementFilterTimeoutPeriod0 = 2 * time.Second
	vAlpha1.MaxTxnBytesPerBlock = 5000000
	Consensus["future"] = vAlpha1

	vAlpha2 := vAlpha1
	vAlpha2.ApprovedUpgrades = map[string]uint64{}
	vAlpha2.AgreementFilterTimeoutPeriod0 = 3500 * time.Millisecond
	vAlpha2.MaxTxnBytesPerBlock = 5 * 1024 * 1024
	Consensus["alpha1"] = vAlpha2
	vAlpha1.ApprovedUpgrades["alpha2"] = 10000

	// vAlpha3 and vAlpha4 use the same parameters as v33 and v34
	vAlpha3 := v33
	vAlpha3.ApprovedUpgrades = map[string]uint64{}
	Consensus["alpha3"] = vAlpha3
	vAlpha2.ApprovedUpgrades["alpha3"] = 10000

	vAlpha4 := v34
	vAlpha4.ApprovedUpgrades = map[string]uint64{}
	Consensus["alpha4"] = vAlpha4
	vAlpha3.ApprovedUpgrades["alpha4"] = 10000

	// vAlpha5 uses the same parameters as v36
	vAlpha5 := v36
	vAlpha5.ApprovedUpgrades = map[string]uint64{}
	Consensus["alpha5"] = vAlpha5
	vAlpha4.ApprovedUpgrades["alpha5"] = 10000
}
